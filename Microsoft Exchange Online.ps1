...
"modifyTime":1787932729294,"name_values":[{"name":"AppId","value":null},{"name":"Organization","valu
e":null},{"name":"PageSize","value":null},{"name":"available_certificates","value":null},{"name":"ce
rtificate","value":null},{"name":"collections","value":["DistributionGroupMembers","DistributionGrou
ps","Mailboxes"]},{"name":"nr_of_sessions","value":null},{"name":"organizational_unit","value":"*"},
{"name":"sessions_idle_timeout","value":null}],"collections":[{"col_name":"DistributionGroups","fiel
ds":[{"field_name":"ExchangeObjectId","field_type":"string","include":true,"field_format":"","field_
source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"Gu
id","field_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","re
f_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"ExternalDirectoryObjectId","field_ty
pe":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"re
ference":false,"ref_col_fields":[]},{"field_name":"Alias","field_type":"string","include":true,"fiel
d_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[
]},{"field_name":"DisplayName","field_type":"string","include":true,"field_format":"","field_source"
:"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]},{"field_name":"Id","fiel
d_type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[]
,"reference":false,"ref_col_fields":[]},{"field_name":"PrimarySmtpAddress","field_type":"string","in
clude":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"
ref_col_fields":[]},{"field_name":"HiddenFromAddressListsEnabled","field_type":"string","include":tr
ue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_f
ields":[]},{"field_name":"HiddenGroupMembershipEnabled","field_type":"string","include":true,"field_
format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]}
,{"field_name":"IsDirSynced","field_type":"string","include":true,"field_format":"","field_source":"
data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":[]}],"key":"ExchangeObjectId",
"display":"Alias","name_values":[{"name":"filter","value":""},{"name":"properties","value":["Alias",
"DisplayName","ExchangeObjectId","ExternalDirectoryObjectId","Guid","HiddenFromAddressListsEnabled",
"HiddenGroupMembershipEnabled","Id","IsDirSynced","PrimarySmtpAddress"]}],"sys_nn":[],"container":""
,"source":"data"},{"col_name":"DistributionGroupMembers","fields":[{"field_name":"GroupGuid","field_
type":"string","include":true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"
reference":false,"ref_col_fields":[]},{"field_name":"Guid","field_type":"string","include":true,"fie
ld_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fields":
[{"col":"Mailboxes","field":"Guid"}]},{"field_name":"RecipientType","field_type":"string","include":
true,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col
_fields":[]},{"field_name":"GroupExchangeObjectId","field_type":"string","include":true,"field_forma
t":"","field_source":"data","javascript":"","ref_col":["DistributionGroups"],"reference":false,"ref_
col_fields":[]},{"field_name":"GroupExternalDirectoryObjectId","field_type":"string","include":true,
"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":false,"ref_col_fiel
ds":[]}],"key":"","display":"GroupGuid","name_values":[],"sys_nn":[{"field_a":"Guid","col_a":"Mailbo
xes","field_b":"GroupExchangeObjectId","col_b":"DistributionGroups"}],"container":"GroupGuid","sourc
e":"data"},{"col_name":"Mailboxes","fields":[{"field_name":"Guid","field_type":"string","include":tr
ue,"field_format":"","field_source":"data","javascript":"","ref_col":[],"reference":true,"ref_col_fi
...
":"ExchangeObjectId","display":"Alias","name_values":[{"name":"filter","value":""},{"name":"properti
es","value":["AcceptMessagesOnlyFrom","AcceptMessagesOnlyFromDLMembers","AcceptMessagesOnlyFromSende
rsOrMembers","AccountDisabled","AddressBookPolicy","Alias","ArchiveDatabase","ArchiveDomain","Archiv
eGuid","ArchiveName","ArchiveRelease","ArchiveState","ArchiveStatus","ArchiveWarningQuota","AuditAdm
in","AuditDelegate","AuditEnabled","AuditLogAgeLimit","AuditOwner","AutoExpandingArchiveEnabled","By
passModerationFromSendersOrMembers","CustomAttribute1","CustomAttribute10","CustomAttribute11","Cust
omAttribute12","CustomAttribute13","CustomAttribute14","CustomAttribute15","CustomAttribute2","Custo
mAttribute3","CustomAttribute4","CustomAttribute5","CustomAttribute6","CustomAttribute7","CustomAttr
ibute8","CustomAttribute9","DeliverToMailboxAndForward","DisabledArchiveDatabase","DisabledArchiveGu
id","DisplayName","EmailAddresses","EmailAddressPolicyEnabled","EndDateForRetentionHold","ExchangeGu
id","ExchangeObjectId","ExtensionCustomAttribute1","ExtensionCustomAttribute2","ExtensionCustomAttri
bute3","ExtensionCustomAttribute4","ExtensionCustomAttribute5","ExternalDirectoryObjectId","Forwardi
ngAddress","ForwardingSmtpAddress","Guid","Id","ImmutableId","IsDirSynced","IsInactiveMailbox","IsMa
ilboxEnabled","IsMonitoringMailbox","IsShared","LitigationHoldDate","LitigationHoldDuration","Litiga
tionHoldEnabled","LitigationHoldOwner","MailboxPlan","MailTip","MaxBlockedSenders","MaxReceiveSize",
"MaxSafeSenders","MaxSendSize","MessageCopyForSendOnBehalfEnabled","MessageCopyForSentAsEnabled","Me
ssageCopyForSMTPClientSubmissionEnabled","MessageRecallProcessingEnabled","MessageTrackingReadStatus
Enabled","PrimarySmtpAddress","RecipientLimits","RecipientType","RecipientTypeDetails","RejectMessag
esFrom","RejectMessagesFromDLMembers","RejectMessagesFromSendersOrMembers","RetentionHoldEnabled","R
etentionPolicy","SCLDeleteEnabled","SCLDeleteThreshold","SCLJunkEnabled","SCLJunkThreshold","SCLQuar
antineEnabled","SCLQuarantineThreshold","SCLRejectEnabled","SCLRejectThreshold","SendModerationNotif
ications","UsageLocation","UserPrincipalName","WhenCreated","WhenMailboxCreated","WhenSoftDeleted"]}
],"sys_nn":[],"container":"","source":"data"}]}]
'@
